<template>
  <nav class="navbar" :class="{ 'mobile-menu-open': mobileMenuOpen }">
    <button class="mobile-menu-toggle" :class="{ open: mobileMenuOpen }" @click="toggleMobileMenu" v-if="isMobile"
      aria-label="Toggle menu" :aria-expanded="mobileMenuOpen.toString()">
      <span class="hamburger-line"></span>
      <span class="hamburger-line"></span>
      <span class="hamburger-line"></span>
    </button>
    <ul class="links" ref="navRef" :style="{ '--barColor': indicatorColor }" :class="{ 'mobile-open': mobileMenuOpen }">
...
.mobile-menu-toggle {
  ...
  border-color: v-bind('indicatorColor');
