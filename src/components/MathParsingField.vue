<template>
  <div class="math-editor" :style="primaryColorStyle">
    <math-field ref="mf" v-model="inputValue" virtual-keyboard-mode="off" toolbar-mode="hidden" menu-bar-visible="false"
      allow-tex-symbols="sqrt,sin,cos,tan,exp,ln,log" smart-fence :style="primaryColorStyle"></math-field>
  </div>
</template>
